...
\begin{tikzpicture}[
    font=\small,
    ray/.style={draw=black, line width=0.82pt, -{Stealth[length=1.9mm,width=1.2mm]}},
    boundary/.style={draw=black, line width=1.45pt},
    construction/.style={draw=black!55, densely dashed, line width=0.45pt},
    dimension/.style={{Stealth[length=1.65mm,width=1.05mm]}-{Stealth[length=1.65mm,width=1.05mm]}, draw=black!70, line width=0.38pt},
    tangent/.style={draw=black!65, line width=0.55pt},
    point/.style={circle, fill=black, inner sep=1.45pt},
    grazingpoint/.style={circle, fill=black, inner sep=1.75pt},
...
\begin{scope}[xshift=0cm]
  ...
  \node[anchor=north west] at (0.02,-0.12) {$h=0$};
  ...
  \node[anchor=south] at (3.48,1.02) {grazing ray};
\end{scope}
...
\begin{scope}[xshift=7.45cm]
  ...
  \node[anchor=south] at (3.20,1.28) {grazing ray};
