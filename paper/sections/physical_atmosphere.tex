...
with altitude as density and pressure decrease.  A simple idealised profile is
\begin{equation}
    n_{\mathrm{a}}(h)
    \simeq
    1+(n_0-1)e^{-h/H},
...
multiple ray paths.  Such effects may substantially shift an apparent horizon
