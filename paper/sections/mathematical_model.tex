...
\begin{figure}[tb]
    \centering
    \resizebox{\textwidth}{!}{\input{figures/grazing_geometry}}
    ...
    tangent at $G$, giving
    $L_{\max}=d(h_{\mathrm{o}})+d(h_{\mathrm{t}})$. The plotted branches use
    the exact exponential-model shape, affinely rescaled for clarity.}
