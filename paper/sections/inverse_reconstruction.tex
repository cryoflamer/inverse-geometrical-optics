...
resulting horizon law.  The same relation can instead be read in reverse.  Given a desired one-sided visibility distance as a function of
endpoint height, the corresponding stratified refractive-index profile can be
reconstructed directly.  This inverse formulation separates mathematical existence from the physical
